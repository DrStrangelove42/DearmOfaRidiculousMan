...
Warp::Warp(int destMap, int destRoom, int destX, int destY, int posx, int posy, Player& p, RenderContext& renderer) : Object(posx, posy, p, "empty", renderer), destMap(destMap), destRoom(destRoom), destX(destX), destY(destY)
{
